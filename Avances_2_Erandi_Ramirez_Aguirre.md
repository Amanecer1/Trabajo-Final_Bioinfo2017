...
Con línea de comando sería:
    ...
    wget https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=pgenome&rettype=fasta&id=$i

    secuencias=curl -s "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=protein&rettype=fasta&id=NC_015577.1 NC_015500.1 NC_015732.1 NC_002967.9 NC_000919.1 NC_015714.1 NC_022097.1 NC_015578.1 NZ_CP009228.1 NC_015385.1"
curl $secuencias$i > $i/knox
for i in APM87900.1,APM87896.1,APM87895.1; do
mkdir $i; do
